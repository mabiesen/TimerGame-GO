...
//@type - none
//@pkg - none
func evaluateInput(theInput string, startTime int64, toggle string) {
	endTime := getCurrentTime()

	switch theInput {
	case "x":
		logTimeSpent(startTime, endTime, toggle)
	case "t":
		logTimeSpent(startTime, endTime, toggle)
	...
	default:
		...
		recurGameContainer(toggle, startTime)
