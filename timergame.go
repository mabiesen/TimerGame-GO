...
//@comparator is prgram specific to evaluate whether user input was expected.
//@return - none
//@type - none
//@pkg - none
...
//@func - getCurrentTime
//@desc - Gets the current time in milliseconds
//@params - none
//@return 1. currentTime float64
//@type - none
//@pkg - "time"
...
//Using scanForInput as stopping mechanism for code
func inGameContainer(toggle string, initStartTime int64){
	theInput := scanForInput()

//evaluate input does most of the heavy lifting
//the function directs in-game user input
//evaluateInput to be used in a recursive fashion with inGameContainer
	evaluateInput(theInput)
}
